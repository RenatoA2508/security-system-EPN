-- Seed de seguridad del Sistema de Seguridad EPN.
-- Fuente: docs/02_MATRIZ_PERMISOS_RLS.md (rol, permiso, rol_permiso),
-- docs/03_DECISIONES_Y_CORRECCIONES.md §D13 (bootstrap admin), §D17
-- (parametro_sistema), §D11 (guardia_punto_control).
-- Se ejecuta con privilegios de servicio (fuera de RLS): patron de bootstrap
-- estandar, unica excepcion documentada a las reglas normales de escritura.
