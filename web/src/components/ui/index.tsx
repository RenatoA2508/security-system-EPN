...
const WARN = new Set(['INACTIVO', 'INACTIVA', 'SUSPENDIDO', 'SUSPENDIDA', 'FALLA', 'FALLA_DE_RED', 'MANTENIMIENTO', 'PENDIENTE', 'FINALIZADA', 'EXPIRADA', 'CERRADA', 'CERRADA_CAMBIO_PASSWORD', 'MEDIO', 'BAJO', 'NO_VERIFICADO', 'BLOQUEO_TEMPORAL'])
